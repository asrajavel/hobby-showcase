...
const config: Config = {
  ...
  tagline: 'Exploring passions, sharing creativity',
  ...
  themeConfig: {
    ...
    image: 'img/hobby-showcase-social-card.jpg',
    navbar: {
      title: 'My Hobby Showcase',
      logo: {
        alt: 'Hobby Showcase Logo',
        src: 'img/logo.svg',
      },
      items: [
        {
          type: 'docSidebar',
          sidebarId: 'hobbySidebar',
          position: 'left',
          label: 'Hobbies',
        },
        {
    ...
    footer: {
      style: 'dark',
      copyright: `Copyright © ${new Date().getFullYear()} My Hobby Showcase. Built with Docusaurus.`,
    },
    prism: {
